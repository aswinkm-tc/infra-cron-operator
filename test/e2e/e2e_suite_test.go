...
import (
	...
	"github.com/aswinkm-tc/infra-cron-operator/test/utils"
)
...
var (
	...
	projectImage = "example.com/cron-operator:v0.0.1"
)
...
func TestE2E(t *testing.T) {
	...
	_, _ = fmt.Fprintf(GinkgoWriter, "Starting cron-operator integration test suite\n")
